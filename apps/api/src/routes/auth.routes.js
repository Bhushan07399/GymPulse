...
const { login, logout, register, createGymAccount, getMyGyms, switchGym } = require('../controllers/auth.controller');
...
authRouter.get('/my-gyms', authenticate, authorize('Owner'), asyncHandler(getMyGyms));
authRouter.post('/switch-gym', authenticate, authorize('Owner'), asyncHandler(switchGym));
